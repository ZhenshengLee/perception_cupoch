...
#ifndef CUPOCH_CONVERSIONS_HPP_
#define CUPOCH_CONVERSIONS_HPP_
...
{
  /**
   * @brief Copy data from a cupoch::geometry::PointCloud to a sensor_msgs::PointCloud2
   *
  ...
  /**
   * @brief Copy data from a sensor_msgs::PointCloud2 to a cupoch::geometry::PointCloud
   *
   * @param ros_pc2 Reference to the sensor_msgs PointCloud2
